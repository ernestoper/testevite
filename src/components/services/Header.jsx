...
import perfilh from '../../assets/img/fundo/servicos.png';
const navigation = {
  solutions: [
    { name: 'Marketing', href: '#' },
    { name: 'Analytics', href: '#' },
        ...
        <div className="lg:flex ">
            ...
            <div className=" md:mt-0 lg:absolute  -right-10 lg:w-6/12">
                <div className="relative w-full lg:-mt-96 ">
                    <div aria-hidden="true" className="lg:ml-32 lg:-mt-96 lg:mb-4 absolute scale-75 md:scale-110 inset-0 m-auto w-full h-full md:w-96 md:h-96 rounded-lg  bg-gradient-to-t from-orange-900 to-orange-900 blur-none "></div>
                      <img src={perfilh} className=" lg:-mt-40 lg:ml-12 relative w-full" alt="wath illustration" loading="lazy" width="320" height="280"/>
                    </div>
            </div>
        </div>
    </div>
