...
import servicos from '../../assets/PRINCIPAL/TELA-SERVICOS/servicos.png';
const navigation = {
  solutions: [
    { name: 'Marketing', href: '#' },
    { name: 'Analytics', href: '#' },
            ...
            <div className=" lg:absolute  lg:right-28 -ml-8 w-11/12 lg:w-6/12">
                <div className="relative w-full lg:-mt-96 ">
                    <div aria-hidden="true" className="  "></div>
                      <img src={servicos} className=" lg:mt-20 lg:ml-16 ml-8 mt-10 relative w-full" alt="wath illustration" loading="lazy" />
                    </div>
            </div>
        </div>
    </div>
