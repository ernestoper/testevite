            ...
            <div className="relative -pr-32 lg:pr-32 mt-8 md:mt-16 space-y-8 sm:w-10/12 md:w-2/3 lg:ml-0 sm:mx-auto   lg:-mr-20 lg:w-7/12">
                ...
                <div className="grid grid-cols-3 space-x-4 md:space-x-6 md:flex md:justify-center lg:justify-start">
                    {navigation.social.map((item) => (
                      <a key={item.name} href={item.href} aria-label="add to slack"  className="p-4 border border-gray-200  rounded-full duration-300 hover:border-cyan-400 hover:shadow-lg hover:shadow-cyan-600/20 dark:hover:border-cyan-300/3">
                        <span className="sr-only">{item.name}</span>
                        <item.icon className="h-6 w-6 text-orange-200" aria-hidden="true" alt="slack logo" loading="lazy" width="128" height="128"/>
                      </a>
                    ))}
