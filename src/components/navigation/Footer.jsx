...
const Footer = () => {
  return (
    <div className='border-t-2 border-azulforte  w-full py-20 h-auto  bg-gradient-to-r from-pretoneon via-pretoneon to-pretoneon border-b-black grid grid-cols-1 '>
    ...
    <div className="mt-3 h-full  bg-gradient-to-r from-pretoneon  to-azuldio">
          <p className="text-base text-white hover:text-roxosombra xl:text-center">&copy; 2023 Edson, Inc. All rights reserved.</p>
      </div>
    </div>
  );
}
