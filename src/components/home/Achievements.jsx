...
import dashedCircle from "../../assets-test/dashed-circle.svg";
import Div from "./Div";

const Achievements = () => {
    return (
        <div className="bg-black  grid grid-cols-2 md:grid-cols-4 gap-[15px] md:gap-[25px] 2xl:gap-[100px] mt-[75px] md:mt-[150px] relative">
