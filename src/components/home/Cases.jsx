...
export default function Cases() {
  return (
    // <div className="relative bg-azuldio px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28">
    //   <div className="absolute inset-0">
    //     <div className="h-1/3 bg-pretoneon sm:h-2/3" />
    //   </div>
    //   <div className="relative mx-auto lg:mx-12 max-w-full">
    //     <div className="text-center">
    //       <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Clientes</h2>
